...
DOMSelectors.form.addEventListener("submit", function (event) {
  ...
  DOMSelectors.display.insertAdjacentHTML(
    ...
    `<div class="display-card" id="display-card">
      ...
      <h2 class="display-firstName" id="names">${monkeys.firstName}</h2>
      <h2 class="display-lastName" id="names">${monkeys.lastName}</h2>
      <img class="display-img" src="${monkeys.picture}"></img>
      <p>You're a monkey</p>
